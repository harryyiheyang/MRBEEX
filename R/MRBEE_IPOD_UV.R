...
taugamma=groupdmcp(x=gamma1,lambda=tauvec[j],cluster.index=cluster.index,a=3)
...
taugammaj=groupdmcp(x=gamma1j,lambda=tauvec[jstar],cluster.index=cluster.index,a=3)
