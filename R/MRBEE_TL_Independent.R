...
tryCatch({
fit.susiej=susie_ss(XtX=XtXj,Xty=Xtyj,yty=ytyj,L=Lvec[istar],n=length(indvalidj),estimate_prior_method="EM",residual_variance=1,model_init=fit.susiej,standardize=F,max_iter=15,residual_variance_lowerbound=1,coverage = coverage.causal,estimate_residual_method=estimate_residual_method)
},error = function(e) {
fit.susiej=susie_ss(XtX=XtXj,Xty=Xtyj,yty=ytyj,L=Lvec[istar],n=length(indvalidj),estimate_prior_method="EM",residual_variance=1,model_init=fit.susiej,standardize=F,max_iter=15,estimate_residual_variance=F,coverage = coverage.causal,estimate_residual_method=estimate_residual_method)
})
...
delta.se=colSD(DeltaList)
delta.cov=cov(DeltaList)
