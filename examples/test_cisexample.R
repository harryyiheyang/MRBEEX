...
fit1=CisMRBEEX(by=by,bX=bX,byse=byse,bXse=bXse,LD=LD,Rxy=Rxy,use.susie=T,xQTL.Nvec=rep(n1,p),ridge=100,pip.thres=0.2)
fit2=CisMRBEEX(by=by,bX=bX,byse=byse,bXse=bXse,LD=LD,Rxy=Rxy,use.susie=F,xQTL.Nvec=rep(n1,p),eQTLfitList=fit1$eQTLfitList,ridge = 100)
fit3=CisMRBEEX(by=by,bX=bX,byse=byse,bXse=bXse,LD=LD,Rxy=Rxy,use.susie=T,xQTL.Nvec=rep(n1,p),eQTLfitList=fit1$eQTLfitList,var.inf=F,ridge = 0)
fit4=CisMRBEEX(by=by,bX=bX,byse=byse,bXse=bXse,LD=LD,Rxy=Rxy,use.susie=F,xQTL.Nvec=rep(n1,p),eQTLfitList=fit1$eQTLfitList,var.inf=F,ridge = 0)
