...
Estimate=cbind(fit_tran_mrbee$theta,fit_mrbee_susie$theta,fit_mrbee$theta,fit_mvcML@Estimate,fit_median@Estimate,fit_lasso@Estimate)
SE=cbind(fit_tran_mrbee$theta.se,fit_mrbee_susie$theta.se,fit_mrbee$theta.se,fit_mvcML@StdError,fit_median@StdError,fit_lasso@StdError)
